...
noremap ,ev :so $MYVIMRC
noremap ,sv :e $MYVIMRC
noremap ,y "+y
nnoremap ,b :call gitblame#echo()
nnoremap <silent> ,rg :RG
nnoremap <silent> ,ga :BCommits
nnoremap <silent> ,gl :Commits
nnoremap <silent> ,l :BLines
...
vnoremap / <Plug>(easymotion-sn)
xnoremap <silent> <lA-n> :call multiple_cursors#select_all("v", 0)
nnoremap <silent> <lA-n> :call multiple_cursors#select_all("n", 1)
...
set mouse=va
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-256noir,~/.vim/plugged/clever-f.vim,~/.vim/plugged/tcomment_vim,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-easymotion,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-multiple-cursors,~/.vim/plugged/vim-tmux-navigator,~/.vim/plugged/git-blame.vim,~/.vim/plugged/vim-easy-align,/usr/share/vim/vimfiles,/usr/share/vim/vim91,/usr/share/vim/vim91/pack/dist/opt/netrw,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=3
set shell=bash
set shiftwidth=4
set showcmd
...
set shortmess+=aoO
badd +0 ~/.dotfiles/hypr/.config/hypr/hyprland.conf
argglobal
%argdel
$argadd ~/.dotfiles/hypr/.config/hypr/hyprland.conf
edit ~/.dotfiles/hypr/.config/hypr/hyprland.conf
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal expandtab
if &filetype != 'hyprlang'
setlocal filetype=hyprlang
endif
setlocal fillchars=
setlocal findfunc=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 57 - ((56 * winheight(0) + 42) / 84)
